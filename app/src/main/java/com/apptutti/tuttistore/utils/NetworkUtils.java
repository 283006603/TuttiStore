...
public class NetworkUtils{
    private static final String TAG = /*NetworkUtils.class.getSimpleName()*/"NetworkUtils";
     ...
     * <p/>
     * such DiscoveryBean WIFI, MOBILE, ETHERNET, BLUETOOTH, etc.
     *
